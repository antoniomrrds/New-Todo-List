...
export const ModalStyled = styled(Modal)`
  ...
  .ant-modal-header {
    ...
    margin-inline-start: ${generateSpacingCss(8)}!important;
    font-weight: ${({ theme }) => theme.typography.fontWeight[700]} !important;
  ...
  .ant-modal-content {
    ...
    padding-bottom: ${generateSpacingCss(0)}!important;
    padding-left: ${generateSpacingCss(0)}!important;
    padding-right: ${generateSpacingCss(0)}!important;
  }
`;
